        ...
        <section className="relative min-h-[65dvh] sm:min-h-[70vh]">
          ...
          <div className="relative mx-auto flex min-h-[65dvh] max-w-7xl flex-col justify-center px-4 py-16 text-center sm:min-h-[70vh] sm:px-6 sm:py-24 lg:px-8">
            ...
            <p className="mx-auto max-w-2xl px-1 text-sm text-zinc-300 sm:text-base md:text-lg">
              Clases para todos los niveles. Consultá horarios y tarifas por WhatsApp.
            </p>
          </div>
        </section>
          ...
          <div className="mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-10 flex flex-col items-center gap-4 text-center sm:mt-14">
              <p className="text-sm text-zinc-600 dark:text-zinc-400 sm:text-base">
                Consultá horarios, tarifas y disponibilidad por WhatsApp.
              </p>
              <a
                href={`https://wa.me/${WHATSAPP_NUMBER}`}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-[48px] items-center justify-center gap-2 rounded-xl bg-red-600 px-8 py-3.5 font-semibold text-white transition-colors hover:bg-red-700 sm:py-4"
              >

  ...
  return (
    <div className="min-h-screen min-w-0 bg-zinc-100 dark:bg-zinc-900">
      <main className="min-w-0 overflow-x-hidden">
        <section className="relative grid min-h-[75dvh] grid-cols-1 md:min-h-[85vh] md:grid-cols-2">
          <div className="flex min-w-0 flex-col justify-center bg-zinc-200 px-4 py-8 dark:bg-zinc-800 sm:px-6 sm:py-16 md:px-8 md:py-20 lg:px-16">
        ...
        <section id="patrocinadores" className="border-t border-zinc-300 bg-zinc-200 py-8 dark:border-zinc-700 dark:bg-zinc-800 sm:py-16 md:py-20">
          <div className="mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-8 text-center sm:mb-12">
              <h2 className="mb-2 text-2xl font-bold uppercase tracking-tight text-zinc-900 dark:text-zinc-100 sm:mb-3 sm:text-3xl md:text-4xl">
                Patrocinadores
        ...
        <section id="contacto" className="border-t border-zinc-300 bg-zinc-100 py-8 dark:border-zinc-700 dark:bg-zinc-900 sm:py-16 md:py-20">
          <div className="mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid min-w-0 gap-3 sm:gap-8 grid-cols-1 sm:grid-cols-2 md:gap-12 lg:grid-cols-3">
            ...
            <div className="mt-6 flex min-w-0 flex-col items-center justify-center rounded-2xl border border-red-600/30 bg-zinc-200 px-4 py-6 text-center dark:border-red-500/40 dark:bg-zinc-800 sm:mt-16 sm:px-6 sm:py-12">
        ...
        <section id="galeria" className="border-t border-zinc-300 bg-zinc-200 py-8 dark:border-zinc-700 dark:bg-zinc-800 sm:py-16 md:py-20">
          <div className="mx-auto min-w-0 max-w-7xl px-4 sm:px-6 lg:px-8">

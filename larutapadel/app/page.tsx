      ...
      <main>
        <section className="relative grid min-h-[85vh] grid-cols-1 md:grid-cols-2">
          <div className="flex flex-col justify-center bg-zinc-200 px-8 py-20 dark:bg-zinc-900 lg:px-16">
            ...
            <p className="mb-8 flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
              <span>📍</span>
        ...
        <section id="el-club" className="border-t border-zinc-300 bg-zinc-200 py-20 dark:border-zinc-800 dark:bg-zinc-900">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-14 text-center">
              ...
              <p className="mx-auto mt-3 flex items-center justify-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                <span>📍</span>
                Pucalan Parcela 27, Nogales
              </p>
            </div>
        ...
        <section id="contacto" className="border-t border-zinc-300 bg-zinc-100 py-20 dark:border-zinc-800 dark:bg-zinc-950">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-16 flex flex-col items-center justify-center rounded-2xl border border-red-600/30 bg-zinc-200 px-6 py-12 text-center dark:bg-zinc-900/50">
              <h2 className="mb-2 text-2xl font-bold text-zinc-900 dark:text-white">LA RUTA PÁDEL CLUB</h2>
              <p className="mb-1 text-sm text-zinc-600 dark:text-zinc-400">Tres canchas full panorámicas</p>
              <p className="mb-6 flex items-center justify-center gap-2 text-sm text-zinc-600 dark:text-zinc-400">
                <span>📍</span>
                Pucalan Parcela 27, Nogales
              </p>
              <p className="mb-6 text-zinc-600 dark:text-zinc-400">Reservas y consultas por WhatsApp o seguinos en Instagram</p>
              <div className="flex flex-wrap items-center justify-center gap-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-lg border-2 border-zinc-400 bg-transparent px-8 py-3 font-semibold text-zinc-700 transition-colors hover:bg-zinc-100 dark:border-zinc-500 dark:text-zinc-300 dark:hover:bg-zinc-800"

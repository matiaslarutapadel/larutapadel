          ...
          <div className="flex flex-col items-center gap-3 text-center sm:flex-row sm:justify-between sm:text-left">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-6">
              <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-zinc-500 dark:text-zinc-400">
                ...
                <a
                  href="https://renzorios.netlify.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-1.5 sm:gap-2 font-semibold text-red-500 hover:text-red-600 transition-all duration-300 hover:scale-105 group dark:text-red-400 dark:hover:text-red-300"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 group-hover:rotate-12 transition-transform flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
                  ...
                  <span className="bg-gradient-to-r from-red-500 to-red-600 bg-clip-text text-transparent dark:from-red-400 dark:to-red-500">
                    rxzkie
                  </span>
                </a>
              </div>
